...
<title>Login - Royal Drapes</title>
...
<style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .logo-titles{font-size:20px;font-weight:700; color:black}
...
<header>
    ...
    <nav class="nav-right">
        ...
        <a href="cart.php" style="position:relative;"><i class="fa-solid fa-cart-shopping"></i> <span></span></a>
